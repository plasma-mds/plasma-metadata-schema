...
<dl>
<dt>Detector</dt>
<dd>Usually one distinct detector belonging to the spectrometer, but sometimes there might be more than one detector, which can be specified here.</dd>
<dt>Detector name</dt>
<dd>Name of the detector. Some instructive name or alias (not needed for compact spectrometer)</dd>
<dt>Detector type</dt>
<dd>Type of the detector, e.g. CCD, CMOS, PD-array (inkl. number of pixels, phosphor, photocathode, spectral sensitivity, kinetic mode, photon counting mode, pixel size, ...</dd>
<dt>Minimum exposure time [ms]</dt>
<dd>Minimum exposure time of the detector</dd>
<dt>Maximum exposure time [ms]</dt>
<dd>Maximum exposure time of the detector</dd>
<dt>Dynamic range [bit]</dt>
<dd>A/D converter resolution (12, 14, 16 bit)</dd>
<dt>Minimum internal delay [ns]</dt>
<dd>Minimum internal delay the detector can realize, relevant e.g. for ICCD.</dd>
